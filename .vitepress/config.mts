...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: nav(),
    sidebar: {
      "/src/others/vitepress/guide/": {
        base: "/src/others/vitepress/guide/",
        items: sidebarVitepressGuide(),
      },
      "/src/others/vitepress/reference/": {
        base: "/src/others/vitepress/reference/",
        items: sidebarVitepressReference(),
      },
    },
    socialLinks: [
  ...
  return [
    ...
    },
    {
      ...
      items: [
        {
          text: "vitepress",
          link: "/src/others/vitepress/guide/what-is-vitepress",
        },
      ],
    },
  ];
